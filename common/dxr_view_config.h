 ...
 * displayxr-runtime test_apps/common/dxr_view_config.h @ 158016f88
 * (branch feat/model-e-fixed-view-count — runtime PR #1533, ADR-041
 * "Model E"; re-vendor from main once that merges).
 */
